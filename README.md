...
| [`@d3ara1n/pi-peek`](./packages/pi-peek) <sup>†</sup> | [![npm version](https://img.shields.io/npm/v/@d3ara1n/pi-peek)](https://www.npmjs.com/package/@d3ara1n/pi-peek) | Shared core for session-record retrieval, streaming reports and main-agent status |
| [`@d3ara1n/pi-peek-user`](./packages/pi-peek-user) <sup>‡</sup> | [![npm version](https://img.shields.io/npm/v/@d3ara1n/pi-peek-user)](https://www.npmjs.com/package/@d3ara1n/pi-peek-user) | `/peek` overlay — inspect your session's records while the main agent keeps working |
| [`@d3ara1n/pi-peek-agent`](./packages/pi-peek-agent) <sup>§</sup><sup>‡</sup> | [![npm version](https://img.shields.io/npm/v/@d3ara1n/pi-peek-agent)](https://www.npmjs.com/package/@d3ara1n/pi-peek-agent) | Cross-instance `peek` tool — retrieve another session's records through pi-mesh |
